    ...
    <div class="col-lg-6">
      ...
      <div class="box-body"> 
        <?php Pjax::begin(['id' => 'new_supplier']) ?>
          ...
          <?= Html::button('+', ['value' => Url::to('index.php?r=requests/createsupplier'), 'class' => 'btn btn-success', 'id' => 'modalButton']) ?>
        <?php Pjax::end() ?>
            <?php
                Modal::begin([
                        'header' => '<h4>Nes supplier</h4>',
                        'id' => 'modal',
                        'size' => 'modal-lg',
                    ]);
        ...
        <?php Pjax::begin(['id' => 'new_produce']) ?>
          ...
          <?= Html::button('+', ['value' => Url::to('index.php?r=requests/createproduce'), 'class' => 'btn btn-success', 'id' => 'modalButton']) ?>
        <?php Pjax::end() ?>
            <?php
                Modal::begin([
...
$('form#{$model->formName()}').on('beforeSubmit', function(e)
{
    ...
    $.post(
        ...
        if(result == 1)
        {
            ...
            $.pjax.reload({container:'#new_request'});
