...
<div class="outofstock-index">
    ...
    <h1><?= Html::encode($this->title) . ' - ' . $element->name . ', ' . $element->nominal?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <div>
        <p>
            <?= Html::a('Взять со склада', ['createfrom',  'idel' => $element->idelements, 'iduser' => yii::$app->user->identity->id], ['class' => 'btn btn-success']) ?>
