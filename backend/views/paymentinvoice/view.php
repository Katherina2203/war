...
<div class="paymentinvoice-view">
    ...
    <h2>Счет № <?= $model->invoice . ' <small>от ' . $model->date_invoice. '</small>' ?></h2>
     ...
     <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'contentOptions' => ['style' => 'max-width: 290px;white-space: normal'],
            ],
            [
                'attribute' => 'idelem',
                'label' => 'Производитель',
            ...
            [
                ...
                'format' => 'raw',
                'value' => function($modelacc, $key, $index){
                    return Html::a(($modelacc->prices->unitPrice. '/' . $modelacc->prices->forUP. ' '. $modelacc->prices->currency->currency), ['prices/view', 'id' => $modelacc->prices->idel]);
                }
            ],
            [
                'attribute' =>  'quantity',
