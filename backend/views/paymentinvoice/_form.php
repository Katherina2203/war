...
<div class="paymentinvoice-form">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <?= $form->field($model, 'date_invoice')->widget(DatePicker::className(), [
                        'clientOptions' => [
                        'autoclose' => true,
                        'format' => 'yyyy-mm-dd'
                    ]
    ...
    <?= $form->field($model, 'idpayer')->dropDownList(ArrayHelper::map(common\models\Payer::find()->all(), 'idpayer', 'name'), ['prompt'=>'Выберите плательщика']); ?>
    ...
    ?>
    <?= $form->field($model, 'confirm')->radioList(['1' => 'Подтверждем', '0' => 'Не подтвержден', '2'=> 'Отмена']) ?>
    <div class="row">        
        <div class="col-sm-6">
