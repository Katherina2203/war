...
<div class="request-status-history-view">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Update'), ['update', 'id' => $model->idreqstatus], ['class' => 'btn btn-primary']) ?>
        <?= Html::a(Yii::t('app', 'Delete'), ['delete', 'id' => $model->idreqstatus], [
