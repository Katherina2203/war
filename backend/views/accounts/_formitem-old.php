...
<div class="accounts-formitem col-md-8">
    ...
    <?= $form->field($model, 'idelem')->dropDownList($elemList,['prompt'=>'Выберите товар'], ['id' => 'idelem'])?>

    <?php Pjax::begin(['id' => 'idprice']) ?>
        <?= $form->field($model, 'idprice')
            //->textInput(['style'=>'width:150px'])
            //->dropDownList($price,['prompt'=>'Выберите price'])
            ->widget(DepDrop::classname(), [
                                                    ...
                                                    'pluginOptions' => [
                                                            ...
                                                            'url' => Url::to(['/processingrequest/price'])
                                                       ]
        ])
            ;?>
    <?php Pjax::end() ?>
